...
<body>
        ...
        <div class="fixed-width clearfix">
            ...
            <div class="search">
                <ul>
                    ...
                    <li><a href="greate.html" target="_blank">註冊</a></li>
                </ul>  
            </div>
            <div class="menu">
                <ul>
                    <li><a href="hamburger.html" target="_blank">首頁</a></li>
        ...
        <div class="fixed-width clearfix">
            <form action="auth.php" method="post">
                <div class="col-12">
                    ...
                    <a href="hamburger.html"><img src="logo.png" alt=""></a>
                    <div class="z1"><input type="text" name="user" id="zz" placeholder="輸入手機號碼或電子郵件" size="35" style="height: 35px; background-color: rgba(241, 241, 241, 0.473);"></div>
                    ...
                    <div class="ro"></div><br>
                    <a href="greate.html" class="rr" target="_blank">忘記密碼?</a>
                </div>
            </form>
            <?php }?>
        </div>
    ...
    <div class="full-width" id="no2">
        <div class="fixed-width clearfix">
            <div class="col-12">
                <h4>沒有帳戶? <a href="greate.html" target="_blank">註冊</a></h4> 
                <?php }else{ ?>
